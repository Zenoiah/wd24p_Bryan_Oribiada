        ...
        <center>
           <div class="card cardsize" style="background: #F6BE00">
                 <h4>Customer Details / Job Order
                            <a href="../pages/customerjobOrder/index.php" class="btn btn-danger">BACK</a></h4> 
                        </div></center>
                    ...
                    <div class="card-body">
                        <form action="code.php" method="POST">
                            ...
                            <div class="mb-3">
                                <button type="submit" name="save_customerz" class="btn btn-success">SUBMIT ORDER</button>
                            </div>
                        </form>
                    </div>
                </div>
